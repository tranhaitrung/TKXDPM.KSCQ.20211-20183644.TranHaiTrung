...
public class Configs {
	...
	//status resource place rush order
	public static final String RUSH_ORDER_SHIPPING_SCREEN_PATH = "/views/fxml/rush_order.fxml";
	public static final String INVOICE_RUSH_ORDER_ONLY = "/views/fxml/invoice_rush_order_only.fxml";
	public static final String INVOICE_RUSH_ORDER_INCLUDE = "/views/fxml/invoice_rush_order_include.fxml";
